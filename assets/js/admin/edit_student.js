$(document).ready(function () {
    $("#studentNumber").keydown(function (e) {
      onlyInteger(e);
    });
    $("#editStudentFormSubmit").click(function () {
      return editStudentFormValidate();
    });
    function editStudentFormValidate() {
      let firstNameError = false;
      let lastNameError = false;
    //   let emailError = false;
    //   let passwordError = false;
    //   let confirmPasswordError = false;
    //   let studentNumberError = false;
      ...
      function studentNumberValidate() {
        ...
        if (studentNumber == "") {
          $("#studentNumberError").empty();
          $("#studentNumberError").text("student number is required.");
          studentNumberError = true;
          return false;
        } else if (studentNumber.length != 9) {
          $("#studentNumberError").empty();
          $("#studentNumberError").text("length of student number must be 9.");
          studentNumberError = true;
          return false;
        } else if (studentNumberExists(studentNumber)) {
          $("#studentNumberError").empty();
          $("#studentNumberError").text("sorry... student number already taken.");
          studentNumberError = true;
          return false;
        } else {
          $("#studentNumberError").empty();
    ...
    function studentNumberExists(studentNumber) {
      ...
      var base_url = window.location.protocol + "//" + window.location.host;
      var pathname =
        "/student_grade_management_system/admin/admin_ajax_requests.php?q=STUDENT_NUMBER_EXISTS";
      var url = base_url.concat(pathname);
      data = {
        //   csrf_test_name: csrf_test_name,
